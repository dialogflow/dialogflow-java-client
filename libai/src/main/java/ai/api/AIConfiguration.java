...
public class AIConfiguration implements Cloneable {
    ...
    /**
     * Get predefined session ID
     * @return If <code>null</code> then new session id would be generated by data service
     */
    ...
    /**
     * Set predefined session ID
     * @param sessionId If <code>null</code> then new session id would be generated by data service
     */
